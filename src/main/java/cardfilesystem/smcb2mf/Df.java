...
import cardfilesystem.smcb2mf.df.esign.Ef;
import cardfilesystem.smcb2mf.df.esign.PrK;
...
public class Df {
    ...
    public static class Esign {
        ...
        public static final cardfilesystem.smcb2mf.df.esign.PrK PrK = new PrK();
    }
}
