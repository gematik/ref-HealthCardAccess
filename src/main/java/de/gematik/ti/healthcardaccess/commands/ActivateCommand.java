...
public class ActivateCommand extends AbstractHealthCardCommand {
     ...
     * @param dfSpecific
     */
    public ActivateCommand(final Key key, final boolean dfSpecific) {
        super(CLA, INS);
     ...
     * @param reference
     */
    public ActivateCommand(final byte[] reference) throws IOException {
        super(CLA, INS);
     ...
     * @param dfSpecific
     */
    public ActivateCommand(final Password password, final boolean dfSpecific) {
        super(CLA, INS);
