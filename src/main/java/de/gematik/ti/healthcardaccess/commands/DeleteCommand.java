...
/**
 * Commands representing Delete Command gemSpec_COS#14.2.4
 */
public class DeleteCommand extends AbstractHealthCardCommand {
     ...
     * @param dfSpecific
     */
    public DeleteCommand(final Key key, final boolean dfSpecific) {
        super(CLA, INS);
     ...
     * @param reference
     */
    public DeleteCommand(final byte[] reference) throws IOException {
        super(CLA, INS);
     ...
     * @param dfSpecific
     */
    public DeleteCommand(final Password password, final boolean dfSpecific) {
        super(CLA, INS);
